 ...
 * @author Admin
 */
@WebServlet(name = "AdminAddProductController", urlPatterns = {"/admin/products/add"})
public class AdminAddProductController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int numberRowInserted = d.insert(new Product(name, model, Integer.parseInt(price), brand, description, Integer.parseInt(quantity), size));

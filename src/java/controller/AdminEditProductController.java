...
public class AdminEditProductController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher requestDispatcher = getServletContext().getRequestDispatcher("/product-edit.jsp");
 ...
 request.setCharacterEncoding("UTF-8");
        ...
        try{
            ...
            d.updateProductByID(new Product(id, name, model, Integer.parseInt(price), brand, description, Integer.parseInt(quantity), size));
